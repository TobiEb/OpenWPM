...
#
# MAIN CONFIG
display_index = 2 # 0 is UNTIL landing page, UNTIL 1-4 subsites, since it is cumulated here
selected_crawl = 1
#
#
#
...
df = df.head(30)
# print(df)
df.to_csv('worst-ad-related-sites-after-browsing.csv', sep='\t', encoding='utf-8', index=False)
