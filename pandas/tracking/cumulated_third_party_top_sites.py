...
if display_index == 0:
    df = pd.DataFrame({'Site':list(sites), 'Total_Requests':list(cumulative_get_0_total_requests), 'Third-Party-Requests':list(cumulative_get_0_tp_requests), 'Third-Party-Percentage':list(cumulative_get_0_tp_percentage)})
# show if subsite 1
if display_index == 1:
    df = pd.DataFrame({'Site':list(sites), 'Total_Requests':list(cumulative_get_1_total_requests), 'Third-Party-Requests':list(cumulative_get_1_tp_requests), 'Third-Party-Percentage':list(cumulative_get_1_tp_percentage)})
# show if subsite 2
if display_index == 2:
    df = pd.DataFrame({'Site':list(sites), 'Total_Requests':list(cumulative_get_2_total_requests), 'Third-Party-Requests':list(cumulative_get_2_tp_requests), 'Third-Party-Percentage':list(cumulative_get_2_tp_percentage)})
# show if subsite 3
if display_index == 3:
    df = pd.DataFrame({'Site':list(sites), 'Total_Requests':list(cumulative_get_3_total_requests), 'Third-Party-Requests':list(cumulative_get_3_tp_requests), 'Third-Party-Percentage':list(cumulative_get_3_tp_percentage)})
# show if subsite 4
if display_index == 4:
    df = pd.DataFrame({'Site':list(sites), 'Total_Requests':list(cumulative_get_4_total_requests), 'Third-Party-Requests':list(cumulative_get_4_tp_requests), 'Third-Party-Percentage':list(cumulative_get_4_tp_percentage)})
# show if browse
if display_index == 5:
