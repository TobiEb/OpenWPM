...
for site in sites:
    ...
    command_sequence_get3 = CommandSequence.CommandSequence(subsites.sub_sites[1], reset=False)
    ...
    command_sequence_get4 = CommandSequence.CommandSequence(subsites.sub_sites[2], reset=False)
    ...
    command_sequence_get5 = CommandSequence.CommandSequence(subsites.sub_sites[3], reset=True)
