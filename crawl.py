...
for site in sites_to_crawl:
    ...
    command_sequence_get1.get(instance=sub_sites_instance, step=0, sleep=default_sleep, timeout=default_timeout)
    ...
    command_sequence_get2.get(instance=sub_sites_instance, step=1, sleep=default_sleep, timeout=default_timeout)
    ...
    command_sequence_get3.get(instance=sub_sites_instance, step=2, sleep=default_sleep, timeout=default_timeout)
    ...
    command_sequence_get4.get(instance=sub_sites_instance, step=3, sleep=default_sleep, timeout=default_timeout)
    ...
    command_sequence_get5.get(instance=sub_sites_instance, step=4, sleep=default_sleep, timeout=default_timeout)
    ...
    command_sequence_browse5.browse(instance=sub_sites_instance, num_links=4, sleep=default_sleep, timeout=(5*default_timeout))
