...
for site in sites_to_crawl:
    ...
    command_sequence_get1.get(step=0, subsites=sub_sites_instance.sub_sites, sleep=default_sleep, timeout=default_timeout)
    ...
    command_sequence_get2.get(step=1, subsites=sub_sites_instance.sub_sites, sleep=default_sleep, timeout=default_timeout)
    ...
    command_sequence_get3.get(step=2, subsites=sub_sites_instance.sub_sites, sleep=default_sleep, timeout=default_timeout)
    ...
    command_sequence_get4.get(step=3, subsites=sub_sites_instance.sub_sites, sleep=default_sleep, timeout=default_timeout)
    ...
    command_sequence_browse5.browse(num_links=4, subsites=sub_sites_instance.sub_sites, sleep=default_sleep, timeout=(5*default_timeout))
