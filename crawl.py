...
for site in sites_to_crawl:
    ...
    command_sequence_get1.get(step=0, instance=sub_sites_instance, sleep=default_sleep, timeout=default_timeout)
    ...
    command_sequence_get2.get(step=1, instance=sub_sites_instance, sleep=default_sleep, timeout=default_timeout)
    ...
    command_sequence_get3.get(step=2, instance=sub_sites_instance, sleep=default_sleep, timeout=default_timeout)
    ...
    command_sequence_get4.get(step=3, instance=sub_sites_instance, sleep=default_sleep, timeout=default_timeout)
    ...
    command_sequence_get5.get(step=4, instance=sub_sites_instance, sleep=default_sleep, timeout=default_timeout)
    ...
    command_sequence_browse5.browse(num_links=4, instance=sub_sites_instance, sleep=default_sleep, timeout=(5*default_timeout))
